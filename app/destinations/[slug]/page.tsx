      ...
      <section className="relative py-32 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="flex flex-wrap justify-center gap-3 mb-6">
            {destination.type && (
              <div className="inline-block px-5 py-2 bg-brand-purple/10 border-2 border-brand-purple/30 rounded-full shadow-md">
            ...
            {destination.isPopular && (
              <div className="inline-block px-5 py-2 bg-yellow-500/20 rounded-full border-2 border-yellow-500/30 shadow-md">
